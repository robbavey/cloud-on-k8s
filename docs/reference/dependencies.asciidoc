...
| link:https://github.com/hashicorp/golang-lru[$$github.com/hashicorp/golang-lru$$] | v0.6.0 | MPL-2.0
| link:https://github.com/hashicorp/vault[$$github.com/hashicorp/vault/api$$] | v1.8.2 | MPL-2.0
...
| link:https://github.com/spf13/viper[$$github.com/spf13/viper$$] | v1.14.0 | MIT
...
| link:https://golang.org/x/net[$$golang.org/x/net$$] | v0.2.0 | BSD-3-Clause
...
| link:https://github.com/kubernetes/api[$$k8s.io/api$$] | v0.25.4 | Apache-2.0
| link:https://github.com/kubernetes/apimachinery[$$k8s.io/apimachinery$$] | v0.25.4 | Apache-2.0
| link:https://github.com/kubernetes/client-go[$$k8s.io/client-go$$] | v0.25.4 | Apache-2.0
...
| link:https://sigs.k8s.io/controller-runtime[$$sigs.k8s.io/controller-runtime$$] | v0.13.1 | Apache-2.0
...
| link:https://cloud.google.com/go/compute[$$cloud.google.com/go/compute$$] | v1.12.1 | Apache-2.0
| link:https://cloud.google.com/go/compute/metadata[$$cloud.google.com/go/compute/metadata$$] | v0.2.1 | Apache-2.0
...
| link:https://golang.org/x/mod[$$golang.org/x/mod$$] | v0.6.0 | BSD-3-Clause
| link:https://golang.org/x/oauth2[$$golang.org/x/oauth2$$] | v0.1.0 | BSD-3-Clause
| link:https://golang.org/x/sync[$$golang.org/x/sync$$] | v0.1.0 | BSD-3-Clause
| link:https://golang.org/x/sys[$$golang.org/x/sys$$] | v0.2.0 | BSD-3-Clause
| link:https://golang.org/x/term[$$golang.org/x/term$$] | v0.2.0 | BSD-3-Clause
...
| link:https://google.golang.org/genproto[$$google.golang.org/genproto$$] | v0.0.0-20221024183307-1bc688fe9f3e | Apache-2.0
| link:https://google.golang.org/grpc[$$google.golang.org/grpc$$] | v1.50.1 | Apache-2.0
